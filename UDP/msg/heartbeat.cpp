...
Heartbeat::Heartbeat(int64_t timestamp_ms, int32_t timestamp_ns, uint8_t error_code,uint8_t status){
...
Heartbeat::Heartbeat() : timestamp_ms(0), timestamp_ns(0), error_code(0), status(0) {}
